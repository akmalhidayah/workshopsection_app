...
<div class="mt-6">
    ...
    <div id="scope-of-work-container">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-2">
            <div>
                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="scope_pekerjaan_1">
                    Scope Pekerjaan
                </label>
            ...
            <div>
                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="qty_1">
                    Qty
                </label>
            ...
            <div>
                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="satuan_1">
                    Satuan
                </label>
