<x-app-layout>
        ...
        <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('scopeofwork.update', ['notificationNumber' => $scopeOfWork->notification_number]) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="notification_number">
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="nama_pekerjaan">
                                Nama Pekerjaan
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="nama_penginput">
                                Nama Penginput
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="tanggal_dokumen">
                                Tanggal Dokumen
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="tanggal_pemakaian">
                                Tanggal Pemakaian
                            </label>
                    ...
                    <div class="mt-6">
                        ...
                        <div id="scope-of-work-container">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-2">
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="scope_pekerjaan_{{ $index + 1 }}">
                                        Scope Pekerjaan
                                    </label>
                                ...
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="qty_{{ $index + 1 }}">
                                        Qty
                                    </label>
                                ...
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="satuan_{{ $index + 1 }}">
                                        Satuan
                                    </label>
                                ...
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="keterangan_{{ $index + 1 }}">
                                        Keterangan
                                    </label>
                    ...
                    <!-- Additional Notes -->
                    <div class="mt-4">
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="catatan">
                            Catatan
                        </label>
    ...
    <script>
        document.getElementById('add-scope-row').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="scope_pekerjaan_${rowCount}">
                        Scope Pekerjaan
                    </label>
                ...
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="qty_${rowCount}">
                        Qty
                    </label>
                ...
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="satuan_${rowCount}">
                        Satuan
                    </label>
                ...
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="keterangan_${rowCount}">
                        Keterangan
                    </label>
