<x-app-layout>
        ...
        <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('abnormal.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="abnormal_title">
                                Abnormal Title
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="notifikasi_no">
                                Nomor Order
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="unit_kerja">
                                Unit Kerja / Section
                            </label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="abnormal_date">
                                Abnormal Date
                            </label>
                    ...
                    <!-- Problem Description -->
                    <div class="mt-4">
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="problem_description">
                    ...
                    <!-- Root Cause -->
                    <div class="mt-4">
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="root_cause">
                    ...
                    <!-- Immediate Actions -->
                    <div class="mt-4">
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="immediate_actions">
                    ...
                    <!-- Summary -->
                    <div class="mt-4">
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="summary">
                    ...
                    <!-- Actions Required -->
                    <div class="mt-6">
                        <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-300">Actions Required</h3>
                        <div id="action-container" class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                            <div>
                                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="action_1">
                                    Action 1
                                </label>
                            ...
                            <div>
                                <label class="block font-medium text-gray-800 dark:text-gray-300" for="by_1">
                                    By
                                </label>
                            ...
                            <div>
                                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="when_1">
                                    When
                                </label>
                        ...
                        <div class="mt-4">
                            <button type="button" id="add-action" class="px-4 py-2 bg-blue-500 text-gray-800 dark:text-gray-300 rounded-lg hover:bg-blue-600 transition duration-300">Tambahkan</button>
                        </div>
                    </div>

                    <!-- Equipment Risk -->
                    <div class="mt-6">
                        <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-300">Equipment Risk</h3>
                        <div id="risk-container" class="grid grid-cols-1 gap-4 mt-2">
                            <div>
                                <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="risk_1">
                                    Risk 1
                                </label>
                        ...
                        <div class="mt-4">
                            <button type="button" id="add-risk" class="px-4 py-2 bg-blue-500 text-gray-800 dark:text-gray-300 rounded-lg hover:bg-blue-600 transition duration-300">Tambahkan</button>
                        </div>
                    </div>

                    <!-- Dokumentasi Abnormalitas -->
                    <div class="mt-6">
                        <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-300">Dokumentasi Abnormalitas (JPG/PNG/JPEG)</h3>
                        <div id="dokumentasi-container" class="grid grid-cols-1 gap-4 mt-2">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="foto_1">
                                        Foto Temuan Abnormalitas 1
                                    </label>
                                    <input id="foto_1" name="fotos[]" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full">
                                </div>
                                <div>
                                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="keterangan_1">
                        ...
                        <div class="mt-4">
                            <button type="button" id="add-dokumentasi" class="px-4 py-2 bg-blue-500 text-gray-800 dark:text-gray-300 rounded-lg hover:bg-blue-600 transition duration-300">Tambahkan</button>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('add-action').addEventListener('click', function () {
            ...
            const actionGroup = `
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="action_${actionCount}">
                        Action ${actionCount}
                    </label>
                ...
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="by_${actionCount}">
                        By
                    </label>
                ...
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="when_${actionCount}">
                        When
                    </label>
        ...
        document.getElementById('add-risk').addEventListener('click', function () {
            ...
            const riskGroup = `
                <div>
                    <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="risk_${riskCount}">
                        Risk ${riskCount}
                    </label>
        ...
        document.getElementById('add-dokumentasi').addEventListener('click', function () {
            ...
            const dokumentasiGroup = `
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="foto_${dokumentasiCount}">
                    ...
                    <div>
                        <label class="block font-medium text-sm text-gray-800 dark:text-gray-300" for="keterangan_${dokumentasiCount}">
