        ...
        <td style="width: 60%; vertical-align: top; padding: 6px;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="text-align: center; padding: 2px 0;">:</td>
                    <td style="padding: 2px 0;">{{ $hpp->requesting_unit }}</td>
                </tr>
                <tr>
                    <td style="font-weight: bold; padding: 2px 0;">UNIT KERJA PENGENDALI</td>
                    <td style="text-align: center; padding: 2px 0;">:</td>
                    <td style="padding: 2px 0;">{{ $hpp->controlling_unit }}</td>
                </tr>
            </table>
        </td>
        ...
        <td style="width: 18%; vertical-align: top; padding: 4px; border-left: 1px solid black;">
            <div style="border: 1px solid black; padding: 4px;">
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: center;">
                            ...
                            <div style="display: flex; flex-direction: column; align-items: center; justify-content: flex-end; height: 70px;">
                                @if(!empty($hpp->general_manager_signature_requesting_unit) && file_exists(storage_path("app/public/signatures/hpp/general_manager_signature_requesting_unit_{$hpp->notification_number}.png")))
                                    <img src="{{ storage_path("app/public/signatures/hpp/general_manager_signature_requesting_unit_{$hpp->notification_number}.png") }}" 
                                         alt="TTD" style="width: 100px; height: 60px; object-fit: contain; filter: drop-shadow(2px 2px 3px black);">
                                @else
                                    <strong style="font-size: 20px;">TTD</strong>
                                @endif
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="3" style="border-top: 1px solid black; border-bottom: 1px solid black; text-align: right; padding: 3px 8px;">
                            ...
                            @if(!empty($hpp->manager_signature) && file_exists(storage_path("app/public/signatures/hpp/manager_signature_requesting_unit_{$hpp->notification_number}.png")))
                                <img src="{{ storage_path("app/public/signatures/hpp/manager_signature_requesting_unit_{$hpp->notification_number}.png") }}" 
                                     alt="Manager Signature" style="width: 60px; height: 20px; object-fit: contain; filter: drop-shadow(2px 2px 3px black); vertical-align: middle;">
                            @else
                                <strong style="font-size: 9px;">TTD</strong>
                            @endif
                        </td>
                    </tr>
                </table>
        ...
        <td class="px-2 py-2" style="width: 50%; border: 1px solid black;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <td colspan="2" class="px-2 py-2 text-right" style="border-top: 1px solid black; border-bottom: 1px solid black; text-align: right;">
                    <strong>{{ $hpp->managerSignatureUser ? $hpp->managerSignatureUser->initials : 'N/A / TTD' }}</strong> 
