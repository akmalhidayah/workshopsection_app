        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h2 class="font-semibold text-2xl text-gray-800 leading-tight mb-6 border-b pb-3">
                    Form Input HPP Bengkel di Atas 250jt
                </h2>

                <!-- Form Input -->
                <form action="{{ route('admin.inputhpp.store_hpp3') }}" method="POST">
                    @csrf
                    <input type="hidden" name="source_form" value="{{ $source_form ?? 'createhpp3' }}">
